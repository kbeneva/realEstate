        ...
        <div>
            ...
            <div className={"displayContainer blue1"}>
                <div className={"displayContent"}>
                    <p className={"displayTitle alignLeft"}>Create an account to make your search easier and enjoyable</p>
                    <p className={"displayText alignLeft"}>You can save properties that catch your eye and instantly contact
                        an agent.</p>
            ...
            <div className={"displayContainer displayContainerReverse blue2"}>
                ...
                <div className={"displayContent"}>
                    ...
                    <p className={"displayText alignRight"}>From houses to condos, you will surely find a property of your
                        liking.</p>
